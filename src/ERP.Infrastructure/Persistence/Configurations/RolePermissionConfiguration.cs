...
public sealed class RolePermissionConfiguration : IEntityTypeConfiguration<RolePermission>
{
    public void Configure(EntityTypeBuilder<RolePermission> builder)
    {
        ...
        builder.HasData(
            ...
            new
            {
                Id = RoleSeed.AdministratorSuppliersManageLinkId,
                RoleId = IdentitySeed.AdministratorRoleId,
                PermissionId = PermissionSeed.SuppliersManageId,
                AssignedAtUtc = RoleSeed.SeededAtUtc
            },
            new
            {
                Id = RoleSeed.AdministratorWarehousesManageLinkId,
                RoleId = IdentitySeed.AdministratorRoleId,
                PermissionId = PermissionSeed.WarehousesManageId,
                AssignedAtUtc = RoleSeed.SeededAtUtc
            },
            new
            {
                Id = RoleSeed.AdministratorReferenceManageLinkId,
                RoleId = IdentitySeed.AdministratorRoleId,
                PermissionId = PermissionSeed.ReferenceManageId,
                AssignedAtUtc = RoleSeed.SeededAtUtc
            },
            new
            {
                Id = RoleSeed.AdministratorCompanyManageLinkId,
                RoleId = IdentitySeed.AdministratorRoleId,
                PermissionId = PermissionSeed.CompanyManageId,
                AssignedAtUtc = RoleSeed.SeededAtUtc
            });
    }
}
