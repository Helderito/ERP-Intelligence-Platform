    ...
    public partial class AddRolesAndPermissions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("6fe633a8-dbed-4dc1-a572-f0e42f7d0d3a"), "roles.manage", "Manage roles and permissions" },
                    { new Guid("97388676-8f9c-4f9c-a2f1-9c972dd4c19d"), "users.manage", "Manage user role assignments" }
                });
